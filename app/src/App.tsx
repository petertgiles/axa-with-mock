...
import { configurationAuth0, configurationGoogle, configurationIdentityServer, configurationIdentityServerWithoutDiscovery, configurationSignInCanada, configurationMockAuth } from './configurations';
...
function App() {
  ...
  return (<>
    ...
    <OidcProvider configuration={configurationMockAuth} onEvent={onEvent}>
      <BrowserRouter>
